...
function start()
{
    document.getElementById("status").innerHTML = "O sistema está ouvindo. Por favor, fale: circulo ou retangulo"
    recognition.start();
} 
...
// atualizar esse texto com o status 
  document.getElementById("status").innerHTML = "A fala foi reconhecida como:"
...
circle(x, y, radius);
    ...
    document.getElementById("status").innerHTML = "UCirculo desenhado";
  drawCircule = "";
  }
